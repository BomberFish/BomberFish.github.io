...
function checkExtension(){
    ...
    if (chrome.extension.ViewType.TAB == "tab" &&
        ...
        //create listeners
        document.getElementById("status").addEventListener("click", function(){ chrome.tabs.create({ url: 'https://chrome.google.com/webstore/detail/boxel-golf/mmgjkfjlmdkmoipndaeombfnomjfgeff/' }); });
